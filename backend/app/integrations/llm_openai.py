    ...
    *,
    ...
    if is_ru:
        system = (
            ...
            "4) Пример ответа (5–8 предложений, от 1-го лица, без выдуманных фактов; недостающие детали — [ ]).\n"
    ...
    if is_ru:
        if is_course:
            system = (
                ...
                "Три правки:\n- ...\n- ...\n- ...\n"
                "Сильный пример (5–8 предложений, по-русски, без выдумок; недостающие детали — в [ ]).\n"
